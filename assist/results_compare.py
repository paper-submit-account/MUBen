...
class Arguments:
    ...
    ori_result_dir: Optional[str] = field(default="./output/RESULTS/", metadata={"help": "Directory the scores."})
    tgt_result_dir: Optional[str] = field(default="./output/RESULTS/", metadata={"help": "Directory the scores."})
    output_dir: Optional[str] = field(default="./output/RESULTS/", metadata={"help": "Where to save the ranks."})
