...
class Arguments:
    ...
    # --- IO arguments ---
    src_folder: Optional[str] = field(default=None, metadata={"help": "Source folder that stores the results."})
    tgt_folder: Optional[str] = field(default=None, metadata={"help": "Target folder that stores the results."})
    ...
    overwrite: Optional[bool] = field(default=False, metadata={"help": "Whether overwrite existing outputs."})
