...
class Arguments:
    ...
    output_dir: Optional[str] = field(default="./data/files/", metadata={"help": "where to save constructed dataset."})
...
def split_and_save(smiles, lbs, masks, ori_ids, lengths, seed, output_dir):
    ...
    ts, ss, tl, sl, tm, sm, tid, sid = train_test_split(ts, tl, tm, tid, test_size=lengths["test"], random_state=seed)
